class ClangFormatAT1606 < Formula
  desc "Formatting tools for C, C++, Obj-C, Java, JavaScript, TypeScript - v16.0.6"
  ...
  bottle do
    root_url "https://github.com/DojoFive/homebrew-dojofive/releases/download/clang-format@16.0.6-16.0.6"
    sha256 cellar: :any_skip_relocation, x86_64_linux: "1e8133850a712dce7c0959d80ec6b2d951db9a54ce0c27f25d3c7f54153dd469"
  end
